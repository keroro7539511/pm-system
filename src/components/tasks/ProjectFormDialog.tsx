...
export function ProjectFormDialog({ open, onOpenChange, onSubmit, loading }: ProjectFormDialogProps) {
  ...
  useEffect(() => {
    if (open) reset({ name: "", status: "active", start_date: "", end_date: "", description: "" });
  }, [open, reset]);
